...
-- Normalize legacy role ids (optional; keeps system consistent).
-- If you still rely on legacy names in code/UI, skip these updates.
...
FOR EACH ROW EXECUTE FUNCTION docutracker_documents_set_doc_number();
