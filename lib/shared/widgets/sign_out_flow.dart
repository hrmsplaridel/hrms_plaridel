...
class _SignOutLoadingOverlayState extends State<SignOutLoadingOverlay>
  ...
  void initState() {
    ...
    _glowPulse = Tween<double>(begin: 0.82, end: 1.0).animate(
            ...
            children: [
              ...
              SafeArea(
                child: Center(
                  child: Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: isNarrow ? 36 : 48),
                    child: Column(
    ...
    for (final ring in _rings) {
      ...
      if (ring.isPrimary) {
        canvas.drawCircle(
          tip,
          3,
          Paint()..color = AppTheme.primaryNavyLight,
        );
      }
      ...
      if (ring.orbitDot) {
        ...
        canvas.drawCircle(
          ...
          r + 1.5,
          Paint()
            ..color = AppTheme.primaryNavyLight.withValues(alpha: 0.35),
        );
        canvas.drawCircle(
          dotCenter,
          r,
