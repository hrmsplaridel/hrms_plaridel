...
class _ManageShiftState extends State<ManageShift> {
  ...
  Future<void> _loadShifts() async {
    ...
    try {
      ...
      debugPrint('Load shifts failed: $e');
      _shifts = [];
    }
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                SizedBox(
                  width: 50,
                  child: Text('ID', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: AppTheme.textPrimary)),
                ),
                Expanded(
                  flex: 1,
                  child: Text('Shift', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: AppTheme.textPrimary)),
                ),
                Expanded(
                  flex: 1,
                  child: Text('Start Time', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: AppTheme.textPrimary)),
                ),
                Expanded(
                  flex: 1,
                  child: Text('End Time', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 13, color: AppTheme.textPrimary)),
                ),
              ],
            ),
          ),
          ...
          if (_loading)
            ...
            Container(
              ...
              child: Text('No shifts', style: TextStyle(color: AppTheme.textSecondary.withOpacity(0.8), fontSize: 14)),
            )
          else
            ...filtered.map((s) {
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          flex: 1,
                          child: Text(s.name, style: TextStyle(fontSize: 13, color: AppTheme.textPrimary)),
                        ),
                        Expanded(
                          flex: 1,
                          child: Text(_timeStr(s.startTime), style: TextStyle(fontSize: 13, color: AppTheme.textPrimary)),
                        ),
                        Expanded(
                          flex: 1,
                          child: Text(_timeStr(s.endTime), style: TextStyle(fontSize: 13, color: AppTheme.textPrimary)),
                        ),
                      ],
                    ),
                  ),
  ...
  Widget _buildRightPanel() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          Text('Shift Name', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppTheme.textSecondary)),
          ...
          const SizedBox(height: 20),
          Text('Start Time', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppTheme.textSecondary)),
          const SizedBox(height: 6),
          _buildTimePicker(_startTime, (t) => setState(() => _startTime = t)),
          const SizedBox(height: 20),
          Text('End Time', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppTheme.textSecondary)),
          const SizedBox(height: 6),
    ...
    return InkWell(
      ...
      child: InputDecorator(
        ...
        child: Text(
          ...
          style: TextStyle(fontSize: 14, color: value != null ? AppTheme.textPrimary : AppTheme.textSecondary),
        ),
      ),
    );
  }
