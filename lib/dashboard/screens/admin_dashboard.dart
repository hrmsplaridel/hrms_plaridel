  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Position, office, dates, and applicant tracking (assessment, exam, deliberation, job offer, assumption, cost). Form only—no pre-filled names.',
          style: TextStyle(color: AppTheme.textSecondary, fontSize: 14),
        ),
        const SizedBox(height: 24),
        if (_editing != null) ...[
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'Register a new user (Admin or Employee). They can sign in after email confirmation if enabled.',
          style: TextStyle(color: AppTheme.textSecondary, fontSize: 14),
        ),
        const SizedBox(height: 24),
        Container(
