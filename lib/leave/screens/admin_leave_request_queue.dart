...
class AdminLeaveLeaveTypeFilterOption {
  const AdminLeaveLeaveTypeFilterOption({required this.value, required this.label});
...
class AdminLeaveRequestQueuePanel extends StatefulWidget {
  ...
  @override
  State<AdminLeaveRequestQueuePanel> createState() => _AdminLeaveRequestQueuePanelState();
}

class _AdminLeaveRequestQueuePanelState extends State<AdminLeaveRequestQueuePanel> {
