...
class AppTheme {
  ...
  static TextStyle dashFieldTextStyle(BuildContext context) => TextStyle(
  ...
  static InputDecorationTheme _inputDecorationTheme(Brightness brightness) {
    ...
    return InputDecorationTheme(
      ...
      floatingLabelStyle: TextStyle(color: floating, fontWeight: FontWeight.w600),
      border: OutlineInputBorder(
        borderRadius: radius,
  ...
  static BoxDecoration dashSurfaceCard(BuildContext context,
      {double radius = 16}) {
