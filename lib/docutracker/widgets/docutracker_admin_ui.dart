...
class DocuTrackerWorkflowStepper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sorted = [...steps]..sort((a, b) => a.stepOrder.compareTo(b.stepOrder));
          ...
          child: Center(
            child: isComplete
                ...
                : Text(
                    ...
                    style: TextStyle(
                      fontWeight: FontWeight.w800,
                      color: isActive ? Colors.white : DocuTrackerTokens.textMuted,
                    ),
                  ),
          ),
        ),
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  _metaPill(
                    hasSteps ? '${steps.length} steps' : 'Draft route',
                  ),
                ],
              ),
            ],
