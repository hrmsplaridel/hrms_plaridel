...
class _RspFinalInterviewReportPreviewScreenState
  ...
  int get _scheduledCount => widget.rows
      .where((r) => r.finalInterviewScheduled.isNotEmpty)
      .length;

  int get _hiredCount =>
      widget.rows.where((r) => r.hired == 'Yes').length;
        ...
        child: Padding(
          ...
          child: Center(
            child: Text(
              label,
              style: TextStyle(
                color: selected ? accent : AppTheme.dashTextSecondaryOf(context),
            ...
            child: Column(
              ...
              children: [
                ...
                if (row.positionApplied.isNotEmpty)
                  Text('Position: ${row.positionApplied}',
                      style: TextStyle(color: secondary, fontSize: 13)),
