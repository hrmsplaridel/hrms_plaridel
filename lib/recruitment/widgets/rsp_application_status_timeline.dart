...
class RspApplicationStatusTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final steps = [
      ...
      _StepData(
        ...
        status:
            _documentReviewStatus(application.status, _hasExamResult),
      ...
      _StepData(
        ...
        subtitle: _examsSubtitle(
            application.status, _hasExamResult, _beiGradingPending),
        status: _examsStatus(
            application.status, _hasExamResult, _beiGradingPending),
  ...
  _TimelineStepStatus _documentReviewStatus(
      String status, bool hasExamResult) {
  ...
  String _examsSubtitle(
      String status, bool hasExamResult, bool beiGradingPending) {
...
class _TimelineStepTile extends StatelessWidget {
  ...
  Color get _lineColor {
    ...
    if (data.status == _TimelineStepStatus.current) return const Color(0xFF1565C0);
