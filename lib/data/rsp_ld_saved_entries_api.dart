...
class RspLdSavedEntriesApi {
  ...
  static Future<Map<String, dynamic>?> getRow(String table, String id) async {
    final res = await ApiClient.instance.get<Map<String, dynamic>>('$_prefix/$table/$id');
    return res.data;
  }

  static Future<void> insertRow(String table, Map<String, dynamic> payload) async {
  ...
  static Future<void> updateRow(String table, String id, Map<String, dynamic> payload) async {
