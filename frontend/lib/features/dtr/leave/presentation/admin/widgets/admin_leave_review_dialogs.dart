...
class AdminLeaveApproveDialog extends StatefulWidget {
  ...
  @override
  State<AdminLeaveApproveDialog> createState() =>
      _AdminLeaveApproveDialogState();
}
          ...
          onPressed: () {
            ...
            Navigator.of(context).pop(
              LeaveApprovalInput(
                ...
                reviewerId: '',
                approvedDaysWithPay: parseAdminLeaveDouble(
                  _withPayController.text,
                ),
...
class AdminLeaveDecisionDialog extends StatefulWidget {
  ...
  @override
  State<AdminLeaveDecisionDialog> createState() =>
      _AdminLeaveDecisionDialogState();
}
