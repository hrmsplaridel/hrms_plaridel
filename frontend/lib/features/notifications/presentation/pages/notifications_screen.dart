...
import 'package:hrms_plaridel/features/notifications/presentation/widgets/notifications_ui.dart';
...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final loading = (np.loading && hrmsEmpty) || (doc.loading && docEmpty);
    ...
    return Scaffold(
      ...
      body: DecoratedBox(
        ...
        child: loading
            ...
            ? NotificationErrorState(message: loadError, onRetry: _reload)
            : allEmpty
...
class _HrmsNotificationList extends StatelessWidget {
  const _HrmsNotificationList({required this.items, required this.onTap});
