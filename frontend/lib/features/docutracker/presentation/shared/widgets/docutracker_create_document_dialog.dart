...
Future<void> showDocuTrackerCreateDocumentDialog(
  ...
  String title = '';
  final typeOptions =
      allowedDocumentTypes == null || allowedDocumentTypes.isEmpty
      ? DocumentType.values
      : DocumentType.values
  ...
  final dialogWidth = isMobile
      ? size.width
      : (size.width * 0.72).clamp(560.0, 820.0);
  final dialogHeight = isMobile
      ? (size.height * 0.9).clamp(420.0, 820.0)
      : (size.height * 0.75).clamp(520.0, 760.0);

  Widget buildForm(BuildContext _) => StatefulBuilder(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${type.displayName} template opens after creation.',
                              style: TextStyle(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ExpansionTile(
                              ...
                              initiallyExpanded: pickedFileName != null,
                              leading: const Icon(Icons.attach_file_rounded),
                              title: const Text('Add attachment'),
                              subtitle: Text(
                                pickedFileName ?? 'Optional',
                                maxLines: 1,
                                  ...
                                  if (uploaded == null) {
                                    ...
                                    setState(() {
                                      ...
                                      inlineError =
                                          ...
                                          ? 'Draft saved, but upload failed: ${docuTrackerDisplayError(uploadErr)}'
