...
import 'package:hrms_plaridel/features/docutracker/presentation/widgets/docutracker_section_header.dart';
...
import 'package:hrms_plaridel/features/docutracker/presentation/widgets/docutracker_summary_card.dart';
import 'package:hrms_plaridel/features/docutracker/presentation/widgets/docutracker_press_scale.dart';
...
class _DocuTrackerDashboardScreenState
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.embedded) {
      ...
      return ColoredBox(color: DocuTrackerTokens.canvasDark, child: content);
    }
    ...
    return Stack(
      ...
      children: [
        SingleChildScrollView(
          ...
          child: dark
              ? ColoredBox(color: DocuTrackerTokens.canvasDark, child: content)
              : content,
        ),
        if (showFab)
          Positioned(
