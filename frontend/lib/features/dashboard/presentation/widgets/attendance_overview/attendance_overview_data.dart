...
enum MonthlyAttendanceBucket { present, late, absent, undertime, onLeave }
...
class MonthlyAttendanceSummary {
  ...
  int get totalCategorized => present + late + absent + undertime + onLeave;
...
MonthlyAttendanceBucket? _bucketForDay(TimeRecord? rec) {
  if (rec != null && (rec.status == 'holiday' || rec.holidayId != null)) {
    return null;
  }
  if (rec != null && (rec.status == 'on_leave' || rec.leaveRequestId != null)) {
