...
import 'package:hrms_plaridel/features/docutracker/data/docutracker_main.dart';
...
import 'package:hrms_plaridel/features/learning_development/presentation/pages/training_daily_report_employee_screen.dart';
import 'package:hrms_plaridel/features/dashboard/presentation/widgets/attendance_overview/attendance_overview.dart';
import 'package:hrms_plaridel/features/dashboard/presentation/widgets/employee_dash_ui.dart';
import 'package:hrms_plaridel/features/dashboard/presentation/widgets/employee_dashboard_skeletons.dart';
...
EdgeInsets _employeeMainScrollPadding(
...
class _EmployeeDashboardState extends State<EmployeeDashboard>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: useMobileLeaveFab || useMobileLocatorFab
          ? FloatingActionButton.extended(
              heroTag: useMobileLeaveFab
                  ? 'employee-dashboard-file-leave-fab'
                  : 'employee-dashboard-file-locator-fab',
              onPressed: useMobileLeaveFab
                  ? _openEmployeeLeaveRequestForm
                  : _openEmployeeLocatorRequestForm,
              icon: const Icon(Icons.add_rounded),
              label: Text(useMobileLeaveFab ? 'File Leave' : 'File Request'),
      ...
      bottomNavigationBar: isWide
          ...
          : DashboardMobileBottomNav(
              ...
              selectedIndex: _selectedNavIndex < _employeeMobileNavItems.length
                  ? _selectedNavIndex
                  : -1,
      ...
      children: [
        ...
        Container(
          padding: EdgeInsets.all(
            isNarrow ? 12 : _employeeSectionCardPadding(context),
          ),
  ...
  Widget build(BuildContext context) {
    return Consumer<DtrProvider>(
      builder: (context, dtr, _) {
        ...
        return Container(
          padding: EdgeInsets.all(
            compactLayout ? 12 : _employeeCardPadding(context),
          ),
    ...
    return Column(
      ...
      children: [
        for (var i = 0; i < records.length; i++) ...[
          _EmployeeAttendanceMobileCard(
            dateLabel: _formatDate(records[i].recordDate),
            amIn: _formatTimeWithLocator(
              records[i],
              records[i].timeIn?.toLocal(),
              'AM IN',
            ),
            amOut: _formatTimeWithLocator(
              records[i],
              records[i].breakOut?.toLocal(),
              'AM OUT',
            ),
            pmIn: _formatTimeWithLocator(
              records[i],
              records[i].breakIn?.toLocal(),
              'PM IN',
            ),
            pmOut: _formatTimeWithLocator(
              records[i],
...
class _EmployeeAttendanceMobileCard extends StatelessWidget {
  const _EmployeeAttendanceMobileCard({
