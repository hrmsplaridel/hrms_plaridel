              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _SectionLabel(text: 'INCLUDED IN REPORT', color: secondary),
                    ...
                    _SectionLabel(text: 'REVIEW FIRST', color: secondary),
                    ...
                    const SizedBox(height: 20),
                    _SectionLabel(text: 'EXPORT DIRECTLY', color: secondary),
                    const SizedBox(height: 10),
                    _ExportOptionTile(
