...
import 'package:hrms_plaridel/features/recruitment/presentation/widgets/rsp_bei_grading_dialog.dart';
import 'package:hrms_plaridel/features/recruitment/presentation/widgets/rsp_exam_editor_ui.dart';
import 'package:hrms_plaridel/features/recruitment/presentation/widgets/rsp_final_interview_scheduler.dart';
import 'package:hrms_plaridel/features/recruitment/utils/rsp_applications_report_export.dart';
import 'package:hrms_plaridel/features/recruitment/presentation/widgets/rsp_generate_report_dialog.dart';
import 'package:hrms_plaridel/features/recruitment/presentation/widgets/rsp_applications_report_preview_screen.dart';
import 'package:hrms_plaridel/core/api/user_facing_api_error.dart';
import 'package:hrms_plaridel/features/recruitment/presentation/widgets/rsp_iframe_preview.dart';
import 'package:hrms_plaridel/features/recruitment/presentation/widgets/rsp_records_list_table.dart';
            ...
            return TableRow(
              ...
              children: [
                ...
                _scoreBreakdownBodyCell(
                  Align(
                    alignment: Alignment.center,
                    child: _scoreBreakdownStatusPill(dialogContext, exam: exam),
                  ),
                  background: rowBg,
                  padding: const EdgeInsets.symmetric(
                    horizontal: 4,
          ...
          child: LayoutBuilder(
            builder: (context, constraints) {
              ...
              return Wrap(
                ...
                runSpacing: 10,
                crossAxisAlignment: WrapCrossAlignment.center,
                children: [viewScoreBtn, generateReportBtn, syncBtn],
              );
            },
          ),
        ),
