...
import 'package:hrms_plaridel/features/recruitment/presentation/widgets/rsp_application_status_timeline.dart';
...
class _ErrorBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isNotFound ? const Color(0xFFFFF3E0) : Colors.red.shade50,
        borderRadius: BorderRadius.circular(14),
        border: Border.all(
          color: isNotFound ? const Color(0xFFFFB74D) : Colors.red.shade200,
        ),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(
            ...
            color: isNotFound ? const Color(0xFFE65100) : Colors.red.shade700,
            size: 22,
          ),
