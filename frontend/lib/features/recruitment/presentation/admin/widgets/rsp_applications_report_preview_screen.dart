...
class _TablePreview extends StatelessWidget {
  const _TablePreview({required this.rows, required this.showAllColumns});
            ...
            child: Column(
              ...
              children: [
                _InfoRow(
                  ...
                  label: 'Position',
                  value: row.positionApplied.isEmpty
                      ? '-'
                      : row.positionApplied,
                ),
...
class _PdfPreviewPane extends StatelessWidget {
  const _PdfPreviewPane({required this.rows, required this.filterSummary});
