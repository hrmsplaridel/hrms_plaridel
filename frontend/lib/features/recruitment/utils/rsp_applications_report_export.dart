...
class RspApplicationsReportRow {
  ...
  static RspApplicationsReportRow fromApplication({
    ...
    String pctOrBlank(double? v) => v == null ? '' : v.toStringAsFixed(1);
    ...
    return RspApplicationsReportRow(
      ...
      examScorePercent: exam == null
          ? ''
          : exam.scorePercent.toStringAsFixed(1),
      ...
      appliedAt: applied,
      applicationLetter: _docLabel(
        app,
        RspApplicationDocKind.applicationLetter,
      ),
      resume: _docLabel(app, RspApplicationDocKind.resume),
      tor: _docLabel(app, RspApplicationDocKind.tor),
      eligibilityTrainings: _docLabel(
        app,
