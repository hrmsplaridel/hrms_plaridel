...
enum TrainingReportAttachmentPreviewKind { image, pdf, unsupported }
...
class _AttachmentPreviewBody extends StatelessWidget {
  const _AttachmentPreviewBody({required this.url, required this.kind});
          ...
          child: InteractiveViewer(
            ...
            child: Center(
              child: Image.network(
                ...
                errorBuilder: (_, __, ___) => _OpenInTabFallback(
                  url: url,
