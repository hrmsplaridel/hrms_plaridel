...
class RspFormHeader extends StatelessWidget {
  const RspFormHeader({super.key, required this.formTitle, this.subtitle});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        Center(child: Container(height: 2, width: 200, color: Colors.black)),
...
class _FooterIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 22,
      height: 22,
      decoration: BoxDecoration(color: _letterheadNavy, shape: BoxShape.circle),
