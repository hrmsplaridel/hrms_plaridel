...
class SidebarCollapseScope extends InheritedWidget {
  ...
  static double of(BuildContext context) {
    final scope = context
        .dependOnInheritedWidgetOfExactType<SidebarCollapseScope>();
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: isCenter
                ? const [AppTheme.primaryNavyLight, AppTheme.primaryNavy]
                : [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: const LinearGradient(
                colors: [_accentOrangeLight, _accentOrange],
              ),
            ),
          ),
        ],
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final arcPaint = Paint()
      ..shader = SweepGradient(
        colors: [arcStartColor, arcEndColor, arcEndColor, arcStartColor],
