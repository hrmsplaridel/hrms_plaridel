  ...
  static List<Widget> biForm(BiFormEntry e) {
    ...
    return [
      ...
      roFieldsGroup(
        ...
        children: List.generate(9, (i) {
          ...
          return Padding(
            ...
            child: roFieldCard('Area ${i + 1}: ${r?.toString() ?? '—'}', desc),
          );
        }),
      ),
      roFieldsGroup(
      ...
      roFieldsGroup(
        ...
        children: [...roField('Additional data', e.otherRelevantInformation)],
      ),
        ...
        roFieldsGroup(
          ...
          children: [
            for (var i = 0; i < e.applicants.length; i++) ...[
              ...
              ...roField(
                'Remark (disability)',
                e.applicants[i].remarkDisability,
              ),
            ],
          ],
        ),
        ...
        roFieldsGroup(
          ...
          children: [
            for (var i = 0; i < e.candidates.length; i++) ...[
              ...
              ...roField(
                'Related experience',
                e.candidates[i].relatedExperience,
              ),
              ...roField('Eligibility', e.candidates[i].eligibility),
              ...roField(
                'Performance rating',
                e.candidates[i].performanceRating,
              ),
        ...
        roFieldsGroup(
          ...
          children: [
            for (var i = 0; i < e.applicants.length; i++) ...[
              ...
              ...roField(
                'Date contract exam',
                e.applicants[i].dateContractExam,
              ),
              ...roField(
